...
module.exports = class extends Functions {
    constructor(props) {
        ...
        this.name = ['dog', 'cachorro'];
        this.helpen = 'Send the image of a dog';
        this.help = 'Envia a imagem de um cachorro';
    }
    ...
    async search() {
        const { body } = await request.get(`https://some-random-api.ml/img/dog`)
