...
module.exports = class extends Functions {
    constructor(props) {
        ...
        this.name = ['bird', 'pássaro', 'passaro', 'passarinho'];
        this.helpen = 'Send the image of a bird';
        this.help = 'Envia a imagem de um pássaro';
    }
    ...
    async search() {
        const { body } = await request.get(`https://some-random-api.ml/img/birb`)
