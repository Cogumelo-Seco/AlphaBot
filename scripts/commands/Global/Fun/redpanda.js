...
module.exports = class extends Functions {
    constructor(props) {
        ...
        this.name = ['redpanda', 'pandavermelho'];
        this.helpen = 'Send the image of a red panda';
        this.help = 'Envia a imagem de um panda vermelho';
    }
    ...
    async search() {
        const { body } = await request.get(`https://some-random-api.ml/img/red_panda`)
